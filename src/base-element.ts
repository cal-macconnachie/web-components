...
export class BaseElement extends LitElement {
  @property({ type: String, attribute: 'data-theme', reflect: true }) theme: string = 'light'
  ...
  connectedCallback() {
    ...
    const documentTheme = document.documentElement.getAttribute('data-theme') as string | null
    const storedTheme = localStorage.getItem(this.storageKey) as string | null
